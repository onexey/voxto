...
- **General** — model selection, configurable recording shortcut, hotkey behavior, startup, and update preferences.
...
See [Hotkeys](hotkeys.md) for the shortcut recorder and supported key combinations.
